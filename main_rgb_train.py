...
def make_work_tree(working_folder, source_folder, frame_width=320, log=None):
    ...
    list_of_videos = [f for f in getListOfFiles(os.path.join(source_folder)) if ('srgb_' in f and 's_' in f) or 'test' in f and f.endswith('.mp4') and '.' not in f]
...
if __name__ == "__main__":
    ...
    working_folder = 'working_folder_rgb'
