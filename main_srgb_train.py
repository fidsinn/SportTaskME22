...
if __name__ == "__main__":
    ...
    working_folder = 'working_folder_srgb'
    ...
    classification_task(working_folder, log=log, test_strokes_segmentation=None) #get_videos_list(os.path.join(working_folder, 'detectionTask', 'test')))
