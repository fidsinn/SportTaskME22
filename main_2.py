...
'''
class My_variables():
    def __init__(self, working_path, data_in, task_name, epochs, model_load, model, size_data=[320,180,96], cuda=True, batch_size=5, workers=10, lr=0.0001, nesterov=True, weight_decay=0.005, momentum=0.5):
